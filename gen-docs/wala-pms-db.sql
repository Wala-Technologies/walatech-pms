...
-- Dumping database structure for walapmsdb
CREATE DATABASE IF NOT EXISTS `walapmsdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `walapmsdb`;

-- Dumping structure for table walapmsdb.bisect_nodes_id_seq
...
-- Dumping structure for table walapmsdb.crm_note_id_seq
...
-- Dumping structure for table walapmsdb.ledger_health_id_seq
...
-- Dumping structure for table walapmsdb.prospect_opportunity_id_seq
...
-- Dumping structure for table walapmsdb.tabAbout Us Team Member
...
-- Dumping structure for table walapmsdb.tabAccess Log
...
-- Dumping structure for table walapmsdb.tabAccount
...
-- Dumping structure for table walapmsdb.tabAccount Closing Balance
...
-- Dumping structure for table walapmsdb.tabAccounting Dimension
...
-- Dumping structure for table walapmsdb.tabAccounting Dimension Detail
...
-- Dumping structure for table walapmsdb.tabAccounting Dimension Filter
...
-- Dumping structure for table walapmsdb.tabAccounting Period
...
-- Dumping structure for table walapmsdb.tabActivity Cost
...
-- Dumping structure for table walapmsdb.tabActivity Log
...
-- Dumping structure for table walapmsdb.tabActivity Type
...
-- Dumping structure for table walapmsdb.tabAddress
...
-- Dumping structure for table walapmsdb.tabAddress Template
...
-- Dumping structure for table walapmsdb.tabAdvance Payment Ledger Entry
...
-- Dumping structure for table walapmsdb.tabAdvance Tax
...
-- Dumping structure for table walapmsdb.tabAdvance Taxes and Charges
...
-- Dumping structure for table walapmsdb.tabAllowed Dimension
...
-- Dumping structure for table walapmsdb.tabAllowed To Transact With
...
-- Dumping structure for table walapmsdb.tabAmended Document Naming Settings
...
-- Dumping structure for table walapmsdb.tabApplicable On Account
...
-- Dumping structure for table walapmsdb.tabAppointment
...
-- Dumping structure for table walapmsdb.tabAppointment Booking Slots
...
-- Dumping structure for table walapmsdb.tabAsset
...
-- Dumping structure for table walapmsdb.tabAsset Activity
...
-- Dumping structure for table walapmsdb.tabAsset Capitalization
...
-- Dumping structure for table walapmsdb.tabAsset Capitalization Asset Item
...
-- Dumping structure for table walapmsdb.tabAsset Capitalization Service Item
...
-- Dumping structure for table walapmsdb.tabAsset Capitalization Stock Item
...
-- Dumping structure for table walapmsdb.tabAsset Category
...
-- Dumping structure for table walapmsdb.tabAsset Category Account
...
-- Dumping structure for table walapmsdb.tabAsset Depreciation Schedule
...
-- Dumping structure for table walapmsdb.tabAsset Finance Book
...
-- Dumping structure for table walapmsdb.tabAsset Maintenance
...
-- Dumping structure for table walapmsdb.tabAsset Maintenance Log
...
-- Dumping structure for table walapmsdb.tabAsset Maintenance Task
...
-- Dumping structure for table walapmsdb.tabAsset Maintenance Team
...
-- Dumping structure for table walapmsdb.tabAsset Movement
...
-- Dumping structure for table walapmsdb.tabAsset Movement Item
...
-- Dumping structure for table walapmsdb.tabAsset Repair
...
-- Dumping structure for table walapmsdb.tabAsset Repair Consumed Item
...
-- Dumping structure for table walapmsdb.tabAsset Shift Allocation
...
-- Dumping structure for table walapmsdb.tabAsset Shift Factor
...
-- Dumping structure for table walapmsdb.tabAsset Value Adjustment
...
-- Dumping structure for table walapmsdb.tabAssignment Rule
...
-- Dumping structure for table walapmsdb.tabAssignment Rule Day
...
-- Dumping structure for table walapmsdb.tabAssignment Rule User
...
-- Dumping structure for table walapmsdb.tabAuthorization Rule
...
-- Dumping structure for table walapmsdb.tabAuto Email Report
...
-- Dumping structure for table walapmsdb.tabAuto Repeat
...
-- Dumping structure for table walapmsdb.tabAuto Repeat Day
...
-- Dumping structure for table walapmsdb.tabAvailability Of Slots
...
-- Dumping structure for table walapmsdb.tabBank
...
-- Dumping structure for table walapmsdb.tabBank Account
...
-- Dumping structure for table walapmsdb.tabBank Account Subtype
...
-- Dumping structure for table walapmsdb.tabBank Account Type
...
-- Dumping structure for table walapmsdb.tabBank Clearance Detail
...
-- Dumping structure for table walapmsdb.tabBank Guarantee
...
-- Dumping structure for table walapmsdb.tabBank Statement Import
...
-- Dumping structure for table walapmsdb.tabBank Transaction
...
-- Dumping structure for table walapmsdb.tabBank Transaction Mapping
...
-- Dumping structure for table walapmsdb.tabBank Transaction Payments
...
-- Dumping structure for table walapmsdb.tabBatch
...
-- Dumping structure for table walapmsdb.tabBin
...
-- Dumping structure for table walapmsdb.tabBisect Nodes
...
-- Dumping structure for table walapmsdb.tabBlanket Order
...
-- Dumping structure for table walapmsdb.tabBlanket Order Item
...
-- Dumping structure for table walapmsdb.tabBlock Module
...
-- Dumping structure for table walapmsdb.tabBlog Category
...
-- Dumping structure for table walapmsdb.tabBlog Post
...
-- Dumping structure for table walapmsdb.tabBlogger
...
-- Dumping structure for table walapmsdb.tabBOM
...
-- Dumping structure for table walapmsdb.tabBOM Creator
...
-- Dumping structure for table walapmsdb.tabBOM Creator Item
...
-- Dumping structure for table walapmsdb.tabBOM Explosion Item
...
-- Dumping structure for table walapmsdb.tabBOM Item
...
-- Dumping structure for table walapmsdb.tabBOM Operation
...
-- Dumping structure for table walapmsdb.tabBOM Scrap Item
...
-- Dumping structure for table walapmsdb.tabBOM Update Batch
...
-- Dumping structure for table walapmsdb.tabBOM Update Log
...
-- Dumping structure for table walapmsdb.tabBOM Website Item
...
-- Dumping structure for table walapmsdb.tabBOM Website Operation
...
-- Dumping structure for table walapmsdb.tabBranch
...
-- Dumping structure for table walapmsdb.tabBrand
...
-- Dumping structure for table walapmsdb.tabBudget
...
-- Dumping structure for table walapmsdb.tabBudget Account
...
-- Dumping structure for table walapmsdb.tabBulk Transaction Log Detail
...
-- Dumping structure for table walapmsdb.tabCalendar View
...
-- Dumping structure for table walapmsdb.tabCall Log
...
-- Dumping structure for table walapmsdb.tabCampaign
...
-- Dumping structure for table walapmsdb.tabCampaign Email Schedule
...
-- Dumping structure for table walapmsdb.tabCampaign Item
...
-- Dumping structure for table walapmsdb.tabCashier Closing
...
-- Dumping structure for table walapmsdb.tabCashier Closing Payments
...
-- Dumping structure for table walapmsdb.tabChangelog Feed
...
-- Dumping structure for table walapmsdb.tabCheque Print Template
...
-- Dumping structure for table walapmsdb.tabClient Script
...
-- Dumping structure for table walapmsdb.tabClosed Document
...
-- Dumping structure for table walapmsdb.tabClosing Stock Balance
...
-- Dumping structure for table walapmsdb.tabCode List
...
-- Dumping structure for table walapmsdb.tabColor
...
-- Dumping structure for table walapmsdb.tabComment
...
-- Dumping structure for table walapmsdb.tabCommon Code
...
-- Dumping structure for table walapmsdb.tabCommunication
...
-- Dumping structure for table walapmsdb.tabCommunication Link
...
-- Dumping structure for table walapmsdb.tabCommunication Medium
...
-- Dumping structure for table walapmsdb.tabCommunication Medium Timeslot
...
-- Dumping structure for table walapmsdb.tabCompany
CREATE TABLE IF NOT EXISTS `tabCompany` (
  ...
  KEY `rgt` (`rgt`),
  KEY `modified` (`modified`),
  KEY `fk_company_currency` (`default_currency`),
  CONSTRAINT `fk_company_currency` FOREIGN KEY (`default_currency`) REFERENCES `tabCurrency` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Data exporting was unselected.

-- Dumping structure for table walapmsdb.tabCompany History
...
-- Dumping structure for table walapmsdb.tabCompetitor
...
-- Dumping structure for table walapmsdb.tabCompetitor Detail
...
-- Dumping structure for table walapmsdb.tabConnected App
...
-- Dumping structure for table walapmsdb.tabConsole Log
...
-- Dumping structure for table walapmsdb.tabContact
...
-- Dumping structure for table walapmsdb.tabContact Email
...
-- Dumping structure for table walapmsdb.tabContact Phone
...
-- Dumping structure for table walapmsdb.tabContract
...
-- Dumping structure for table walapmsdb.tabContract Fulfilment Checklist
...
-- Dumping structure for table walapmsdb.tabContract Template
...
-- Dumping structure for table walapmsdb.tabContract Template Fulfilment Terms
...
-- Dumping structure for table walapmsdb.tabCost Center
CREATE TABLE IF NOT EXISTS `tabCost Center` (
  ...
  KEY `modified` (`modified`),
  KEY `lft_rgt_index` (`lft`,`rgt`),
  KEY `fk_costcenter_company` (`company`),
  CONSTRAINT `fk_costcenter_company` FOREIGN KEY (`company`) REFERENCES `tabCompany` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Data exporting was unselected.

-- Dumping structure for table walapmsdb.tabCost Center Allocation
...
-- Dumping structure for table walapmsdb.tabCost Center Allocation Percentage
...
-- Dumping structure for table walapmsdb.tabCountry
...
-- Dumping structure for table walapmsdb.tabCoupon Code
...
-- Dumping structure for table walapmsdb.tabCRM Note
...
-- Dumping structure for table walapmsdb.tabCurrency
...
-- Dumping structure for table walapmsdb.tabCurrency Exchange
...
-- Dumping structure for table walapmsdb.tabCurrency Exchange Settings Details
...
-- Dumping structure for table walapmsdb.tabCurrency Exchange Settings Result
...
-- Dumping structure for table walapmsdb.tabCustom DocPerm
...
-- Dumping structure for table walapmsdb.tabCustom Field
...
-- Dumping structure for table walapmsdb.tabCustom HTML Block
...
-- Dumping structure for table walapmsdb.tabCustom Role
...
-- Dumping structure for table walapmsdb.tabCustomer
...
-- Dumping structure for table walapmsdb.tabCustomer Credit Limit
...
-- Dumping structure for table walapmsdb.tabCustomer Group
...
-- Dumping structure for table walapmsdb.tabCustomer Group Item
...
-- Dumping structure for table walapmsdb.tabCustomer Item
...
-- Dumping structure for table walapmsdb.tabCustomize Form Field
...
-- Dumping structure for table walapmsdb.tabCustoms Tariff Number
...
-- Dumping structure for table walapmsdb.tabDashboard
...
-- Dumping structure for table walapmsdb.tabDashboard Chart
...
-- Dumping structure for table walapmsdb.tabDashboard Chart Field
...
-- Dumping structure for table walapmsdb.tabDashboard Chart Link
...
-- Dumping structure for table walapmsdb.tabDashboard Chart Source
...
-- Dumping structure for table walapmsdb.tabDashboard Settings
...
-- Dumping structure for table walapmsdb.tabData Import
...
-- Dumping structure for table walapmsdb.tabData Import Log
...
-- Dumping structure for table walapmsdb.tabDefaultValue
...
-- Dumping structure for table walapmsdb.tabDeleted Document
...
-- Dumping structure for table walapmsdb.tabDelivery Note
...
-- Dumping structure for table walapmsdb.tabDelivery Note Item
...
-- Dumping structure for table walapmsdb.tabDelivery Stop
...
-- Dumping structure for table walapmsdb.tabDelivery Trip
...
-- Dumping structure for table walapmsdb.tabDepartment
...
-- Dumping structure for table walapmsdb.tabDependent Task
...
-- Dumping structure for table walapmsdb.tabDepreciation Schedule
...
-- Dumping structure for table walapmsdb.tabDesignation
...
-- Dumping structure for table walapmsdb.tabDesktop Icon
...
-- Dumping structure for table walapmsdb.tabDiscounted Invoice
...
-- Dumping structure for table walapmsdb.tabDiscussion Reply
...
-- Dumping structure for table walapmsdb.tabDiscussion Topic
...
-- Dumping structure for table walapmsdb.tabDocField
...
-- Dumping structure for table walapmsdb.tabDocPerm
...
-- Dumping structure for table walapmsdb.tabDocShare
...
-- Dumping structure for table walapmsdb.tabDocType
...
-- Dumping structure for table walapmsdb.tabDocType Action
...
-- Dumping structure for table walapmsdb.tabDocType Layout
...
-- Dumping structure for table walapmsdb.tabDocType Layout Field
...
-- Dumping structure for table walapmsdb.tabDocType Link
...
-- Dumping structure for table walapmsdb.tabDocType State
...
-- Dumping structure for table walapmsdb.tabDocument Follow
...
-- Dumping structure for table walapmsdb.tabDocument Naming Rule
...
-- Dumping structure for table walapmsdb.tabDocument Naming Rule Condition
...
-- Dumping structure for table walapmsdb.tabDocument Share Key
...
-- Dumping structure for table walapmsdb.tabDomain
...
-- Dumping structure for table walapmsdb.tabDowntime Entry
...
-- Dumping structure for table walapmsdb.tabDriver
...
-- Dumping structure for table walapmsdb.tabDriving License Category
...
-- Dumping structure for table walapmsdb.tabDunning
...
-- Dumping structure for table walapmsdb.tabDunning Letter Text
...
-- Dumping structure for table walapmsdb.tabDunning Type
...
-- Dumping structure for table walapmsdb.tabDynamic Link
...
-- Dumping structure for table walapmsdb.tabEmail Account
...
-- Dumping structure for table walapmsdb.tabEmail Campaign
...
-- Dumping structure for table walapmsdb.tabEmail Digest
...
-- Dumping structure for table walapmsdb.tabEmail Digest Recipient
...
-- Dumping structure for table walapmsdb.tabEmail Domain
...
-- Dumping structure for table walapmsdb.tabEmail Flag Queue
...
-- Dumping structure for table walapmsdb.tabEmail Group
...
-- Dumping structure for table walapmsdb.tabEmail Group Member
...
-- Dumping structure for table walapmsdb.tabEmail Queue
...
-- Dumping structure for table walapmsdb.tabEmail Queue Recipient
...
-- Dumping structure for table walapmsdb.tabEmail Rule
...
-- Dumping structure for table walapmsdb.tabEmail Template
...
-- Dumping structure for table walapmsdb.tabEmail Unsubscribe
...
-- Dumping structure for table walapmsdb.tabEmployee
...
-- Dumping structure for table walapmsdb.tabEmployee Education
...
-- Dumping structure for table walapmsdb.tabEmployee External Work History
...
-- Dumping structure for table walapmsdb.tabEmployee Group
...
-- Dumping structure for table walapmsdb.tabEmployee Group Table
...
-- Dumping structure for table walapmsdb.tabEmployee Internal Work History
...
-- Dumping structure for table walapmsdb.tabEnergy Point Log
...
-- Dumping structure for table walapmsdb.tabEnergy Point Rule
...
-- Dumping structure for table walapmsdb.tabError Log
...
-- Dumping structure for table walapmsdb.tabEvent
...
-- Dumping structure for table walapmsdb.tabEvent Participants
...
-- Dumping structure for table walapmsdb.tabExchange Rate Revaluation
...
-- Dumping structure for table walapmsdb.tabExchange Rate Revaluation Account
...
-- Dumping structure for table walapmsdb.tabFile
...
-- Dumping structure for table walapmsdb.tabFinance Book
...
-- Dumping structure for table walapmsdb.tabFiscal Year
...
-- Dumping structure for table walapmsdb.tabFiscal Year Company
...
-- Dumping structure for table walapmsdb.tabForm Tour
...
-- Dumping structure for table walapmsdb.tabForm Tour Step
...
-- Dumping structure for table walapmsdb.tabGender
...
-- Dumping structure for table walapmsdb.tabGL Entry
...
-- Dumping structure for table walapmsdb.tabGlobal Search DocType
...
-- Dumping structure for table walapmsdb.tabGoogle Calendar
...
-- Dumping structure for table walapmsdb.tabGoogle Contacts
...
-- Dumping structure for table walapmsdb.tabHas Domain
...
-- Dumping structure for table walapmsdb.tabHas Role
...
-- Dumping structure for table walapmsdb.tabHelp Article
...
-- Dumping structure for table walapmsdb.tabHelp Category
...
-- Dumping structure for table walapmsdb.tabHoliday
...
-- Dumping structure for table walapmsdb.tabHoliday List
...
-- Dumping structure for table walapmsdb.tabHomepage Section
...
-- Dumping structure for table walapmsdb.tabHomepage Section Card
...
-- Dumping structure for table walapmsdb.tabIMAP Folder
...
-- Dumping structure for table walapmsdb.tabImport Supplier Invoice
...
-- Dumping structure for table walapmsdb.tabIncoming Call Handling Schedule
...
-- Dumping structure for table walapmsdb.tabIncoming Call Settings
...
-- Dumping structure for table walapmsdb.tabIncoterm
...
-- Dumping structure for table walapmsdb.tabIndustry Type
...
-- Dumping structure for table walapmsdb.tabInstallation Note
...
-- Dumping structure for table walapmsdb.tabInstallation Note Item
...
-- Dumping structure for table walapmsdb.tabInstalled Application
...
-- Dumping structure for table walapmsdb.tabIntegration Request
...
-- Dumping structure for table walapmsdb.tabInventory Dimension
...
-- Dumping structure for table walapmsdb.tabInvoice Discounting
...
-- Dumping structure for table walapmsdb.tabIssue
...
-- Dumping structure for table walapmsdb.tabIssue Priority
...
-- Dumping structure for table walapmsdb.tabIssue Type
...
-- Dumping structure for table walapmsdb.tabItem
CREATE TABLE IF NOT EXISTS `tabItem` (
  ...
  KEY `modified` (`modified`),
  KEY `fk_item_uom` (`stock_uom`),
  CONSTRAINT `fk_item_uom` FOREIGN KEY (`stock_uom`) REFERENCES `tabUOM` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Data exporting was unselected.

-- Dumping structure for table walapmsdb.tabItem Alternative
...
-- Dumping structure for table walapmsdb.tabItem Attribute
...
-- Dumping structure for table walapmsdb.tabItem Attribute Value
...
-- Dumping structure for table walapmsdb.tabItem Barcode
...
-- Dumping structure for table walapmsdb.tabItem Customer Detail
...
-- Dumping structure for table walapmsdb.tabItem Default
...
-- Dumping structure for table walapmsdb.tabItem Group
...
-- Dumping structure for table walapmsdb.tabItem Manufacturer
...
-- Dumping structure for table walapmsdb.tabItem Price
...
-- Dumping structure for table walapmsdb.tabItem Quality Inspection Parameter
...
-- Dumping structure for table walapmsdb.tabItem Reorder
...
-- Dumping structure for table walapmsdb.tabItem Supplier
...
-- Dumping structure for table walapmsdb.tabItem Tax
...
-- Dumping structure for table walapmsdb.tabItem Tax Template
...
-- Dumping structure for table walapmsdb.tabItem Tax Template Detail
...
-- Dumping structure for table walapmsdb.tabItem Variant
...
-- Dumping structure for table walapmsdb.tabItem Variant Attribute
...
-- Dumping structure for table walapmsdb.tabItem Website Specification
...
-- Dumping structure for table walapmsdb.tabJob Card
...
-- Dumping structure for table walapmsdb.tabJob Card Item
...
-- Dumping structure for table walapmsdb.tabJob Card Operation
...
-- Dumping structure for table walapmsdb.tabJob Card Scheduled Time
...
-- Dumping structure for table walapmsdb.tabJob Card Scrap Item
...
-- Dumping structure for table walapmsdb.tabJob Card Time Log
...
-- Dumping structure for table walapmsdb.tabJournal Entry
...
-- Dumping structure for table walapmsdb.tabJournal Entry Account
...
-- Dumping structure for table walapmsdb.tabJournal Entry Template
...
-- Dumping structure for table walapmsdb.tabJournal Entry Template Account
...
-- Dumping structure for table walapmsdb.tabKanban Board
...
-- Dumping structure for table walapmsdb.tabKanban Board Column
...
-- Dumping structure for table walapmsdb.tabLanded Cost Item
...
-- Dumping structure for table walapmsdb.tabLanded Cost Purchase Receipt
...
-- Dumping structure for table walapmsdb.tabLanded Cost Taxes and Charges
...
-- Dumping structure for table walapmsdb.tabLanded Cost Voucher
...
-- Dumping structure for table walapmsdb.tabLanguage
...
-- Dumping structure for table walapmsdb.tabLDAP Group Mapping
...
-- Dumping structure for table walapmsdb.tabLead
...
-- Dumping structure for table walapmsdb.tabLead Source
...
-- Dumping structure for table walapmsdb.tabLedger Health
...
-- Dumping structure for table walapmsdb.tabLedger Health Monitor Company
...
-- Dumping structure for table walapmsdb.tabLedger Merge
...
-- Dumping structure for table walapmsdb.tabLedger Merge Accounts
...
-- Dumping structure for table walapmsdb.tabLetter Head
...
-- Dumping structure for table walapmsdb.tabLinked Location
...
-- Dumping structure for table walapmsdb.tabList Filter
...
-- Dumping structure for table walapmsdb.tabList View Settings
...
-- Dumping structure for table walapmsdb.tabLocation
...
-- Dumping structure for table walapmsdb.tabLog Setting User
...
-- Dumping structure for table walapmsdb.tabLogs To Clear
...
-- Dumping structure for table walapmsdb.tabLost Reason Detail
...
-- Dumping structure for table walapmsdb.tabLower Deduction Certificate
...
-- Dumping structure for table walapmsdb.tabLoyalty Point Entry
...
-- Dumping structure for table walapmsdb.tabLoyalty Point Entry Redemption
...
-- Dumping structure for table walapmsdb.tabLoyalty Program
...
-- Dumping structure for table walapmsdb.tabLoyalty Program Collection
...
-- Dumping structure for table walapmsdb.tabMaintenance Schedule
...
-- Dumping structure for table walapmsdb.tabMaintenance Schedule Detail
...
-- Dumping structure for table walapmsdb.tabMaintenance Schedule Item
...
-- Dumping structure for table walapmsdb.tabMaintenance Team Member
...
-- Dumping structure for table walapmsdb.tabMaintenance Visit
...
-- Dumping structure for table walapmsdb.tabMaintenance Visit Purpose
...
-- Dumping structure for table walapmsdb.tabManufacturer
...
-- Dumping structure for table walapmsdb.tabMarket Segment
...
-- Dumping structure for table walapmsdb.tabMarketing Campaign
...
-- Dumping structure for table walapmsdb.tabMaterial Request
...
-- Dumping structure for table walapmsdb.tabMaterial Request Item
...
-- Dumping structure for table walapmsdb.tabMaterial Request Plan Item
...
-- Dumping structure for table walapmsdb.tabMilestone
...
-- Dumping structure for table walapmsdb.tabMilestone Tracker
...
-- Dumping structure for table walapmsdb.tabMode of Payment
...
-- Dumping structure for table walapmsdb.tabMode of Payment Account
...
-- Dumping structure for table walapmsdb.tabModule Def
...
-- Dumping structure for table walapmsdb.tabModule Onboarding
...
-- Dumping structure for table walapmsdb.tabModule Profile
...
-- Dumping structure for table walapmsdb.tabMonthly Distribution
...
-- Dumping structure for table walapmsdb.tabMonthly Distribution Percentage
...
-- Dumping structure for table walapmsdb.tabNavbar Item
...
-- Dumping structure for table walapmsdb.tabNetwork Printer Settings
...
-- Dumping structure for table walapmsdb.tabNewsletter
...
-- Dumping structure for table walapmsdb.tabNewsletter Attachment
...
-- Dumping structure for table walapmsdb.tabNewsletter Email Group
...
-- Dumping structure for table walapmsdb.tabNon Conformance
...
-- Dumping structure for table walapmsdb.tabNote
...
-- Dumping structure for table walapmsdb.tabNote Seen By
...
-- Dumping structure for table walapmsdb.tabNotification
...
-- Dumping structure for table walapmsdb.tabNotification Log
...
-- Dumping structure for table walapmsdb.tabNotification Recipient
...
-- Dumping structure for table walapmsdb.tabNotification Settings
...
-- Dumping structure for table walapmsdb.tabNotification Subscribed Document
...
-- Dumping structure for table walapmsdb.tabNumber Card
...
-- Dumping structure for table walapmsdb.tabNumber Card Link
...
-- Dumping structure for table walapmsdb.tabOAuth Authorization Code
...
-- Dumping structure for table walapmsdb.tabOAuth Bearer Token
...
-- Dumping structure for table walapmsdb.tabOAuth Client
...
-- Dumping structure for table walapmsdb.tabOAuth Client Role
...
-- Dumping structure for table walapmsdb.tabOAuth Scope
...
-- Dumping structure for table walapmsdb.tabOnboarding Permission
...
-- Dumping structure for table walapmsdb.tabOnboarding Step
...
-- Dumping structure for table walapmsdb.tabOnboarding Step Map
...
-- Dumping structure for table walapmsdb.tabOpening Invoice Creation Tool Item
...
-- Dumping structure for table walapmsdb.tabOperation
...
-- Dumping structure for table walapmsdb.tabOpportunity
...
-- Dumping structure for table walapmsdb.tabOpportunity Item
...
-- Dumping structure for table walapmsdb.tabOpportunity Lost Reason
...
-- Dumping structure for table walapmsdb.tabOpportunity Lost Reason Detail
...
-- Dumping structure for table walapmsdb.tabOpportunity Type
...
-- Dumping structure for table walapmsdb.tabOverdue Payment
...
-- Dumping structure for table walapmsdb.tabPackage
...
-- Dumping structure for table walapmsdb.tabPackage Import
...
-- Dumping structure for table walapmsdb.tabPackage Release
...
-- Dumping structure for table walapmsdb.tabPacked Item
...
-- Dumping structure for table walapmsdb.tabPacking Slip
...
-- Dumping structure for table walapmsdb.tabPacking Slip Item
...
-- Dumping structure for table walapmsdb.tabPage
...
-- Dumping structure for table walapmsdb.tabParty Account
...
-- Dumping structure for table walapmsdb.tabParty Link
...
-- Dumping structure for table walapmsdb.tabParty Specific Item
...
-- Dumping structure for table walapmsdb.tabParty Type
...
-- Dumping structure for table walapmsdb.tabPatch Log
...
-- Dumping structure for table walapmsdb.tabPause SLA On Status
...
-- Dumping structure for table walapmsdb.tabPayment Entry
...
-- Dumping structure for table walapmsdb.tabPayment Entry Deduction
...
-- Dumping structure for table walapmsdb.tabPayment Entry Reference
...
-- Dumping structure for table walapmsdb.tabPayment Gateway Account
...
-- Dumping structure for table walapmsdb.tabPayment Ledger Entry
...
-- Dumping structure for table walapmsdb.tabPayment Order
...
-- Dumping structure for table walapmsdb.tabPayment Order Reference
...
-- Dumping structure for table walapmsdb.tabPayment Request
...
-- Dumping structure for table walapmsdb.tabPayment Schedule
...
-- Dumping structure for table walapmsdb.tabPayment Term
...
-- Dumping structure for table walapmsdb.tabPayment Terms Template
...
-- Dumping structure for table walapmsdb.tabPayment Terms Template Detail
...
-- Dumping structure for table walapmsdb.tabPegged Currency Details
...
-- Dumping structure for table walapmsdb.tabPeriod Closing Voucher
...
-- Dumping structure for table walapmsdb.tabPersonal Data Deletion Request
...
-- Dumping structure for table walapmsdb.tabPersonal Data Deletion Step
...
-- Dumping structure for table walapmsdb.tabPersonal Data Download Request
...
-- Dumping structure for table walapmsdb.tabPick List
...
-- Dumping structure for table walapmsdb.tabPick List Item
...
-- Dumping structure for table walapmsdb.tabPlant Floor
...
-- Dumping structure for table walapmsdb.tabPortal Menu Item
...
-- Dumping structure for table walapmsdb.tabPortal User
...
-- Dumping structure for table walapmsdb.tabPOS Closing Entry
...
-- Dumping structure for table walapmsdb.tabPOS Closing Entry Detail
...
-- Dumping structure for table walapmsdb.tabPOS Closing Entry Taxes
...
-- Dumping structure for table walapmsdb.tabPOS Customer Group
...
-- Dumping structure for table walapmsdb.tabPOS Field
...
-- Dumping structure for table walapmsdb.tabPOS Invoice
...
-- Dumping structure for table walapmsdb.tabPOS Invoice Item
...
-- Dumping structure for table walapmsdb.tabPOS Invoice Merge Log
...
-- Dumping structure for table walapmsdb.tabPOS Invoice Reference
...
-- Dumping structure for table walapmsdb.tabPOS Item Group
...
-- Dumping structure for table walapmsdb.tabPOS Opening Entry
...
-- Dumping structure for table walapmsdb.tabPOS Opening Entry Detail
...
-- Dumping structure for table walapmsdb.tabPOS Payment Method
...
-- Dumping structure for table walapmsdb.tabPOS Profile
...
-- Dumping structure for table walapmsdb.tabPOS Profile User
...
-- Dumping structure for table walapmsdb.tabPOS Search Fields
...
-- Dumping structure for table walapmsdb.tabPrepared Report
...
-- Dumping structure for table walapmsdb.tabPrice List
...
-- Dumping structure for table walapmsdb.tabPrice List Country
...
-- Dumping structure for table walapmsdb.tabPricing Rule
...
-- Dumping structure for table walapmsdb.tabPricing Rule Brand
...
-- Dumping structure for table walapmsdb.tabPricing Rule Detail
...
-- Dumping structure for table walapmsdb.tabPricing Rule Item Code
...
-- Dumping structure for table walapmsdb.tabPricing Rule Item Group
...
-- Dumping structure for table walapmsdb.tabPrint Format
...
-- Dumping structure for table walapmsdb.tabPrint Format Field Template
...
-- Dumping structure for table walapmsdb.tabPrint Heading
...
-- Dumping structure for table walapmsdb.tabPrint Style
...
-- Dumping structure for table walapmsdb.tabProcess Deferred Accounting
...
-- Dumping structure for table walapmsdb.tabProcess Payment Reconciliation
...
-- Dumping structure for table walapmsdb.tabProcess Payment Reconciliation Log
...
-- Dumping structure for table walapmsdb.tabProcess Payment Reconciliation Log Allocations
...
-- Dumping structure for table walapmsdb.tabProcess Statement Of Accounts
...
-- Dumping structure for table walapmsdb.tabProcess Statement Of Accounts CC
...
-- Dumping structure for table walapmsdb.tabProcess Statement Of Accounts Customer
...
-- Dumping structure for table walapmsdb.tabProcess Subscription
...
-- Dumping structure for table walapmsdb.tabProduct Bundle
...
-- Dumping structure for table walapmsdb.tabProduct Bundle Item
...
-- Dumping structure for table walapmsdb.tabProduction Plan
...
-- Dumping structure for table walapmsdb.tabProduction Plan Item
...
-- Dumping structure for table walapmsdb.tabProduction Plan Item Reference
...
-- Dumping structure for table walapmsdb.tabProduction Plan Material Request
...
-- Dumping structure for table walapmsdb.tabProduction Plan Material Request Warehouse
...
-- Dumping structure for table walapmsdb.tabProduction Plan Sales Order
...
-- Dumping structure for table walapmsdb.tabProduction Plan Sub Assembly Item
...
-- Dumping structure for table walapmsdb.tabProject
...
-- Dumping structure for table walapmsdb.tabProject Template
...
-- Dumping structure for table walapmsdb.tabProject Template Task
...
-- Dumping structure for table walapmsdb.tabProject Type
...
-- Dumping structure for table walapmsdb.tabProject Update
...
-- Dumping structure for table walapmsdb.tabProject User
...
-- Dumping structure for table walapmsdb.tabPromotional Scheme
...
-- Dumping structure for table walapmsdb.tabPromotional Scheme Price Discount
...
-- Dumping structure for table walapmsdb.tabPromotional Scheme Product Discount
...
-- Dumping structure for table walapmsdb.tabProperty Setter
...
-- Dumping structure for table walapmsdb.tabProspect
...
-- Dumping structure for table walapmsdb.tabProspect Lead
...
-- Dumping structure for table walapmsdb.tabProspect Opportunity
...
-- Dumping structure for table walapmsdb.tabPSOA Cost Center
...
-- Dumping structure for table walapmsdb.tabPSOA Project
...
-- Dumping structure for table walapmsdb.tabPurchase Invoice
...
-- Dumping structure for table walapmsdb.tabPurchase Invoice Advance
...
-- Dumping structure for table walapmsdb.tabPurchase Invoice Item
...
-- Dumping structure for table walapmsdb.tabPurchase Order
...
-- Dumping structure for table walapmsdb.tabPurchase Order Item
...
-- Dumping structure for table walapmsdb.tabPurchase Order Item Supplied
...
-- Dumping structure for table walapmsdb.tabPurchase Receipt
...
-- Dumping structure for table walapmsdb.tabPurchase Receipt Item
...
-- Dumping structure for table walapmsdb.tabPurchase Receipt Item Supplied
...
-- Dumping structure for table walapmsdb.tabPurchase Taxes and Charges
...
-- Dumping structure for table walapmsdb.tabPurchase Taxes and Charges Template
...
-- Dumping structure for table walapmsdb.tabPutaway Rule
...
-- Dumping structure for table walapmsdb.tabQuality Action
...
-- Dumping structure for table walapmsdb.tabQuality Action Resolution
...
-- Dumping structure for table walapmsdb.tabQuality Feedback
...
-- Dumping structure for table walapmsdb.tabQuality Feedback Parameter
...
-- Dumping structure for table walapmsdb.tabQuality Feedback Template
...
-- Dumping structure for table walapmsdb.tabQuality Feedback Template Parameter
...
-- Dumping structure for table walapmsdb.tabQuality Goal
...
-- Dumping structure for table walapmsdb.tabQuality Goal Objective
...
-- Dumping structure for table walapmsdb.tabQuality Inspection
...
-- Dumping structure for table walapmsdb.tabQuality Inspection Parameter
...
-- Dumping structure for table walapmsdb.tabQuality Inspection Parameter Group
...
-- Dumping structure for table walapmsdb.tabQuality Inspection Reading
...
-- Dumping structure for table walapmsdb.tabQuality Inspection Template
...
-- Dumping structure for table walapmsdb.tabQuality Meeting
...
-- Dumping structure for table walapmsdb.tabQuality Meeting Agenda
...
-- Dumping structure for table walapmsdb.tabQuality Meeting Minutes
...
-- Dumping structure for table walapmsdb.tabQuality Procedure
...
-- Dumping structure for table walapmsdb.tabQuality Procedure Process
...
-- Dumping structure for table walapmsdb.tabQuality Review
...
-- Dumping structure for table walapmsdb.tabQuality Review Objective
...
-- Dumping structure for table walapmsdb.tabQuery Parameters
...
-- Dumping structure for table walapmsdb.tabQuotation
...
-- Dumping structure for table walapmsdb.tabQuotation Item
...
-- Dumping structure for table walapmsdb.tabQuotation Lost Reason
...
-- Dumping structure for table walapmsdb.tabQuotation Lost Reason Detail
...
-- Dumping structure for table walapmsdb.tabReminder
...
-- Dumping structure for table walapmsdb.tabReport
...
-- Dumping structure for table walapmsdb.tabReport Column
...
-- Dumping structure for table walapmsdb.tabReport Filter
...
-- Dumping structure for table walapmsdb.tabRepost Accounting Ledger
...
-- Dumping structure for table walapmsdb.tabRepost Accounting Ledger Items
...
-- Dumping structure for table walapmsdb.tabRepost Allowed Types
...
-- Dumping structure for table walapmsdb.tabRepost Item Valuation
...
-- Dumping structure for table walapmsdb.tabRepost Payment Ledger
...
-- Dumping structure for table walapmsdb.tabRepost Payment Ledger Items
...
-- Dumping structure for table walapmsdb.tabRequest for Quotation
...
-- Dumping structure for table walapmsdb.tabRequest for Quotation Item
...
-- Dumping structure for table walapmsdb.tabRequest for Quotation Supplier
...
-- Dumping structure for table walapmsdb.tabReview Level
...
-- Dumping structure for table walapmsdb.tabRole
...
-- Dumping structure for table walapmsdb.tabRole Profile
...
-- Dumping structure for table walapmsdb.tabRoute History
...
-- Dumping structure for table walapmsdb.tabRouting
...
-- Dumping structure for table walapmsdb.tabSales Invoice
...
-- Dumping structure for table walapmsdb.tabSales Invoice Advance
...
-- Dumping structure for table walapmsdb.tabSales Invoice Item
...
-- Dumping structure for table walapmsdb.tabSales Invoice Payment
...
-- Dumping structure for table walapmsdb.tabSales Invoice Timesheet
...
-- Dumping structure for table walapmsdb.tabSales Order
...
-- Dumping structure for table walapmsdb.tabSales Order Item
...
-- Dumping structure for table walapmsdb.tabSales Partner
...
-- Dumping structure for table walapmsdb.tabSales Partner Item
...
-- Dumping structure for table walapmsdb.tabSales Partner Type
...
-- Dumping structure for table walapmsdb.tabSales Person
...
-- Dumping structure for table walapmsdb.tabSales Stage
...
-- Dumping structure for table walapmsdb.tabSales Taxes and Charges
...
-- Dumping structure for table walapmsdb.tabSales Taxes and Charges Template
...
-- Dumping structure for table walapmsdb.tabSales Team
...
-- Dumping structure for table walapmsdb.tabSalutation
...
-- Dumping structure for table walapmsdb.tabScheduled Job Log
...
-- Dumping structure for table walapmsdb.tabScheduled Job Type
...
-- Dumping structure for table walapmsdb.tabScheduler Event
...
-- Dumping structure for table walapmsdb.tabSerial and Batch Bundle
...
-- Dumping structure for table walapmsdb.tabSerial and Batch Entry
...
-- Dumping structure for table walapmsdb.tabSerial No
...
-- Dumping structure for table walapmsdb.tabSeries
...
-- Dumping structure for table walapmsdb.tabServer Script
...
-- Dumping structure for table walapmsdb.tabService Day
...
-- Dumping structure for table walapmsdb.tabService Level Agreement
...
-- Dumping structure for table walapmsdb.tabService Level Priority
...
-- Dumping structure for table walapmsdb.tabSession Default
...
-- Dumping structure for table walapmsdb.tabSessions
...
-- Dumping structure for table walapmsdb.tabShare Balance
...
-- Dumping structure for table walapmsdb.tabShare Transfer
...
-- Dumping structure for table walapmsdb.tabShare Type
...
-- Dumping structure for table walapmsdb.tabShareholder
...
-- Dumping structure for table walapmsdb.tabShipment
...
-- Dumping structure for table walapmsdb.tabShipment Delivery Note
...
-- Dumping structure for table walapmsdb.tabShipment Parcel
...
-- Dumping structure for table walapmsdb.tabShipment Parcel Template
...
-- Dumping structure for table walapmsdb.tabShipping Rule
...
-- Dumping structure for table walapmsdb.tabShipping Rule Condition
...
-- Dumping structure for table walapmsdb.tabShipping Rule Country
...
-- Dumping structure for table walapmsdb.tabSingles
...
-- Dumping structure for table walapmsdb.tabSLA Fulfilled On Status
...
-- Dumping structure for table walapmsdb.tabSlack Webhook URL
...
-- Dumping structure for table walapmsdb.tabSMS Log
...
-- Dumping structure for table walapmsdb.tabSMS Parameter
...
-- Dumping structure for table walapmsdb.tabSocial Link Settings
...
-- Dumping structure for table walapmsdb.tabSocial Login Key
...
-- Dumping structure for table walapmsdb.tabSouth Africa VAT Account
...
-- Dumping structure for table walapmsdb.tabSouth Africa VAT Settings
...
-- Dumping structure for table walapmsdb.tabStock Entry
...
-- Dumping structure for table walapmsdb.tabStock Entry Detail
CREATE TABLE IF NOT EXISTS `tabStock Entry Detail` (
  ...
  KEY `parent` (`parent`),
  KEY `fk_stock_warehouse` (`s_warehouse`),
...
-- Dumping structure for table walapmsdb.tabStock Entry Type
...
-- Dumping structure for table walapmsdb.tabStock Ledger Entry
...
-- Dumping structure for table walapmsdb.tabStock Reconciliation
...
-- Dumping structure for table walapmsdb.tabStock Reconciliation Item
...
-- Dumping structure for table walapmsdb.tabStock Reservation Entry
...
-- Dumping structure for table walapmsdb.tabSub Operation
...
-- Dumping structure for table walapmsdb.tabSubcontracting BOM
...
-- Dumping structure for table walapmsdb.tabSubcontracting Order
...
-- Dumping structure for table walapmsdb.tabSubcontracting Order Item
...
-- Dumping structure for table walapmsdb.tabSubcontracting Order Service Item
...
-- Dumping structure for table walapmsdb.tabSubcontracting Order Supplied Item
...
-- Dumping structure for table walapmsdb.tabSubcontracting Receipt
...
-- Dumping structure for table walapmsdb.tabSubcontracting Receipt Item
...
-- Dumping structure for table walapmsdb.tabSubcontracting Receipt Supplied Item
...
-- Dumping structure for table walapmsdb.tabSubmission Queue
...
-- Dumping structure for table walapmsdb.tabSubscription
...
-- Dumping structure for table walapmsdb.tabSubscription Invoice
...
-- Dumping structure for table walapmsdb.tabSubscription Plan
...
-- Dumping structure for table walapmsdb.tabSubscription Plan Detail
...
-- Dumping structure for table walapmsdb.tabSuccess Action
...
-- Dumping structure for table walapmsdb.tabSupplier
...
-- Dumping structure for table walapmsdb.tabSupplier Group
...
-- Dumping structure for table walapmsdb.tabSupplier Group Item
...
-- Dumping structure for table walapmsdb.tabSupplier Item
...
-- Dumping structure for table walapmsdb.tabSupplier Quotation
...
-- Dumping structure for table walapmsdb.tabSupplier Quotation Item
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Criteria
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Period
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Scoring Criteria
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Scoring Standing
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Scoring Variable
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Standing
...
-- Dumping structure for table walapmsdb.tabSupplier Scorecard Variable
...
-- Dumping structure for table walapmsdb.tabSupport Search Source
...
-- Dumping structure for table walapmsdb.tabTag
...
-- Dumping structure for table walapmsdb.tabTag Link
...
-- Dumping structure for table walapmsdb.tabTarget Detail
...
-- Dumping structure for table walapmsdb.tabTask
...
-- Dumping structure for table walapmsdb.tabTask Depends On
...
-- Dumping structure for table walapmsdb.tabTask Type
...
-- Dumping structure for table walapmsdb.tabTax Category
...
-- Dumping structure for table walapmsdb.tabTax Rule
...
-- Dumping structure for table walapmsdb.tabTax Withheld Vouchers
...
-- Dumping structure for table walapmsdb.tabTax Withholding Account
...
-- Dumping structure for table walapmsdb.tabTax Withholding Category
...
-- Dumping structure for table walapmsdb.tabTax Withholding Rate
...
-- Dumping structure for table walapmsdb.tabTelephony Call Type
...
-- Dumping structure for table walapmsdb.tabTerms and Conditions
...
-- Dumping structure for table walapmsdb.tabTerritory
...
-- Dumping structure for table walapmsdb.tabTerritory Item
...
-- Dumping structure for table walapmsdb.tabTimesheet
...
-- Dumping structure for table walapmsdb.tabTimesheet Detail
...
CREATE TABLE IF NOT EXISTS `tabToDo` (
  ...
  KEY `modified` (`modified`),
  KEY `reference_type_reference_name_index` (`reference_type`,`reference_name`),
  KEY `fk_todo_user` (`owner`),
  CONSTRAINT `fk_todo_user` FOREIGN KEY (`owner`) REFERENCES `tabUser` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Data exporting was unselected.

-- Dumping structure for table walapmsdb.tabToken Cache
...
-- Dumping structure for table walapmsdb.tabTop Bar Item
...
-- Dumping structure for table walapmsdb.tabTransaction Deletion Record
...
-- Dumping structure for table walapmsdb.tabTransaction Deletion Record Details
...
-- Dumping structure for table walapmsdb.tabTransaction Deletion Record Item
...
-- Dumping structure for table walapmsdb.tabTransaction Log
...
-- Dumping structure for table walapmsdb.tabTranslation
...
-- Dumping structure for table walapmsdb.tabUAE VAT Account
...
-- Dumping structure for table walapmsdb.tabUAE VAT Settings
...
-- Dumping structure for table walapmsdb.tabUnhandled Email
...
-- Dumping structure for table walapmsdb.tabUnreconcile Payment
...
-- Dumping structure for table walapmsdb.tabUnreconcile Payment Entries
...
-- Dumping structure for table walapmsdb.tabUOM
...
-- Dumping structure for table walapmsdb.tabUOM Category
...
-- Dumping structure for table walapmsdb.tabUOM Conversion Detail
...
-- Dumping structure for table walapmsdb.tabUOM Conversion Factor
...
-- Dumping structure for table walapmsdb.tabUser
...
-- Dumping structure for table walapmsdb.tabUser Document Type
...
-- Dumping structure for table walapmsdb.tabUser Email
...
-- Dumping structure for table walapmsdb.tabUser Group
...
-- Dumping structure for table walapmsdb.tabUser Group Member
...
-- Dumping structure for table walapmsdb.tabUser Permission
...
-- Dumping structure for table walapmsdb.tabUser Select Document Type
...
-- Dumping structure for table walapmsdb.tabUser Social Login
...
-- Dumping structure for table walapmsdb.tabUser Type
...
-- Dumping structure for table walapmsdb.tabUser Type Module
...
-- Dumping structure for table walapmsdb.tabVariant Field
...
-- Dumping structure for table walapmsdb.tabVehicle
...
-- Dumping structure for table walapmsdb.tabVersion
...
-- Dumping structure for table walapmsdb.tabVideo
...
-- Dumping structure for table walapmsdb.tabView Log
...
-- Dumping structure for table walapmsdb.tabVoice Call Settings
...
-- Dumping structure for table walapmsdb.tabWarehouse
...
-- Dumping structure for table walapmsdb.tabWarehouse Type
...
-- Dumping structure for table walapmsdb.tabWarranty Claim
...
-- Dumping structure for table walapmsdb.tabWeb Form
...
-- Dumping structure for table walapmsdb.tabWeb Form Field
...
-- Dumping structure for table walapmsdb.tabWeb Form List Column
...
-- Dumping structure for table walapmsdb.tabWeb Page
...
-- Dumping structure for table walapmsdb.tabWeb Page Block
...
-- Dumping structure for table walapmsdb.tabWeb Page View
...
-- Dumping structure for table walapmsdb.tabWeb Template
...
-- Dumping structure for table walapmsdb.tabWeb Template Field
...
-- Dumping structure for table walapmsdb.tabWebhook
...
-- Dumping structure for table walapmsdb.tabWebhook Data
...
-- Dumping structure for table walapmsdb.tabWebhook Header
...
-- Dumping structure for table walapmsdb.tabWebhook Request Log
...
-- Dumping structure for table walapmsdb.tabWebsite Attribute
...
-- Dumping structure for table walapmsdb.tabWebsite Filter Field
...
-- Dumping structure for table walapmsdb.tabWebsite Item Group
...
-- Dumping structure for table walapmsdb.tabWebsite Meta Tag
...
-- Dumping structure for table walapmsdb.tabWebsite Route Meta
...
-- Dumping structure for table walapmsdb.tabWebsite Route Redirect
...
-- Dumping structure for table walapmsdb.tabWebsite Sidebar
...
-- Dumping structure for table walapmsdb.tabWebsite Sidebar Item
...
-- Dumping structure for table walapmsdb.tabWebsite Slideshow
...
-- Dumping structure for table walapmsdb.tabWebsite Slideshow Item
...
-- Dumping structure for table walapmsdb.tabWebsite Theme
...
-- Dumping structure for table walapmsdb.tabWebsite Theme Ignore App
...
-- Dumping structure for table walapmsdb.tabWork Order
...
-- Dumping structure for table walapmsdb.tabWork Order Item
...
-- Dumping structure for table walapmsdb.tabWork Order Operation
...
-- Dumping structure for table walapmsdb.tabWorkflow
...
-- Dumping structure for table walapmsdb.tabWorkflow Action
...
-- Dumping structure for table walapmsdb.tabWorkflow Action Master
...
-- Dumping structure for table walapmsdb.tabWorkflow Action Permitted Role
...
-- Dumping structure for table walapmsdb.tabWorkflow Document State
...
-- Dumping structure for table walapmsdb.tabWorkflow State
...
-- Dumping structure for table walapmsdb.tabWorkflow Transition
...
-- Dumping structure for table walapmsdb.tabWorkspace
...
-- Dumping structure for table walapmsdb.tabWorkspace Chart
...
-- Dumping structure for table walapmsdb.tabWorkspace Custom Block
...
-- Dumping structure for table walapmsdb.tabWorkspace Link
...
-- Dumping structure for table walapmsdb.tabWorkspace Number Card
...
-- Dumping structure for table walapmsdb.tabWorkspace Quick List
...
-- Dumping structure for table walapmsdb.tabWorkspace Shortcut
...
-- Dumping structure for table walapmsdb.tabWorkstation
...
-- Dumping structure for table walapmsdb.tabWorkstation Type
...
-- Dumping structure for table walapmsdb.tabWorkstation Working Hour
...
-- Dumping structure for table walapmsdb.web_form_list_column_id_seq
...
-- Dumping structure for table walapmsdb.__Auth
...
-- Dumping structure for table walapmsdb.__global_search
...
-- Dumping structure for table walapmsdb.__UserSettings
